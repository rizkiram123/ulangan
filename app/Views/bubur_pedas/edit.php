    ...
    <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
        ...
        <form action="<?= base_url('/buburpedas/update/' . $menu['id']) ?>" method="post" class="p-8 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="4" placeholder="Penjelasan menu..." class="w-full px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm transition"><?= old('deskripsi', $menu['deskripsi']) ?></textarea>
            </div>
